...
public class AbilityToUnitLinkage {
	...
	public static void initialiseUnitAbilityLinkageData() {
		...
		UnitAbility.put("Azurite Lion", 		constructArrayListAbility(	new A_U_DoubleAttacker(false, null, null), 
																			new A_U_SummonAnywhere(false, null, null)));	
		UnitAbility.put("Fire Spitter", 		constructArrayListAbility(	new A_U_RangedAttacker(false,null, (BasicObjectBuilders.loadEffect(StaticConfFiles.f1_projectiles)))));	
