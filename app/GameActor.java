...
public class GameActor extends AbstractActor {
	...
	public GameActor(ActorRef out) {
		...
		// Get the list of image files to pre-load the UI with(background, game screen, sprites etc
		//creates a large list of all of this and reports to the front end that the back end is ready to go
		Set<String> images = ImageListForPreLoad.getImageListForPreLoad();
		
		//actor is waiting in a passive state and waiting for a message to do something
		try {
